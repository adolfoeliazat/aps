...
public class UsersTsvTrigger extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -394101766;
     ...
     */
    public UsersTsvTrigger() {
        super("users_tsv_trigger", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("trigger"));
