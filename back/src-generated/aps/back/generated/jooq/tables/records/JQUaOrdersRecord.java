...
public class JQUaOrdersRecord extends UpdatableRecordImpl<JQUaOrdersRecord> implements Record20<Long, Boolean, Timestamp, Timestamp, Object, Long, Long, String, JQUaDocumentType, JQDocumentUrgency, Timestamp, Integer, Integer, JQUaAcademicLevel, Integer, Integer, String, String, JQOrderState, Long> {

    private static final long serialVersionUID = 221595620;
     ...
     */
    @Override
    public Row20<Long, Boolean, Timestamp, Timestamp, Object, Long, Long, String, JQUaDocumentType, JQDocumentUrgency, Timestamp, Integer, Integer, JQUaAcademicLevel, Integer, Integer, String, String, JQOrderState, Long> fieldsRow() {
     ...
     */
    @Override
    public Row20<Long, Boolean, Timestamp, Timestamp, Object, Long, Long, String, JQUaDocumentType, JQDocumentUrgency, Timestamp, Integer, Integer, JQUaAcademicLevel, Integer, Integer, String, String, JQOrderState, Long> valuesRow() {
     ...
     */
    public JQUaOrdersRecord(Long id, Boolean deleted, Timestamp insertedAt, Timestamp updatedAt, Object tsv, Long creatorId, Long customerId, String title, JQUaDocumentType documentType, JQDocumentUrgency documentUrgency, Timestamp deadline, Integer pageCost, Integer price, JQUaAcademicLevel academicLevel, Integer numPages, Integer numSources, String details, String adminNotes, JQOrderState state, Long writerId) {
        super(JQUaOrders.UA_ORDERS);
