...
// */
//
//// This is a hacked https://github.com/JetBrains/kotlin/blob/master/compiler/cli/src/org/jetbrains/kotlin/cli/common/CLICompiler.java
//
//package kommon.org.jetbrains.kotlin.cli.common;
//
...
//
//public abstract class IntoCLICompiler<A extends CommonCompilerArguments> {
...
//            // @into-kotlin
////            args = IntoKotlinShit.INSTANCE.getArgs();
...
//
//        // @into-kotlin
//        MessageCollector collector = new TersePrintingMessageCollector(errStream, messageRenderer, arguments.verbose);
...
//                                "Kotlin Compiler version " + KotlinVersion.CURRENT,
//                                CompilerMessageLocation.NO_LOCATION);
//    }
//
//    /**
...
//     */
//    public static void doMain(@NotNull IntoCLICompiler compiler, @NotNull String[] args) {
...
//
//            // @into-kotlin
//            if (exitCode != OK && exitCode != COMPILATION_ERROR) {
...
//    @NotNull
//    public static ExitCode doMainNoExit(@NotNull IntoCLICompiler compiler, @NotNull String[] args) {
//        try {
...
//
//// @into-kotlin
//class TersePrintingMessageCollector implements MessageCollector {
//    private final boolean verbose;
//    private final PrintStream errStream;
//    private final MessageRenderer messageRenderer;
//    private boolean hasErrors = false;
//
//    TersePrintingMessageCollector(@NotNull PrintStream errStream, @NotNull MessageRenderer messageRenderer, boolean verbose) {
