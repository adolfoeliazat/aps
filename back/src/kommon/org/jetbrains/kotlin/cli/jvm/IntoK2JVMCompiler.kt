...
// */
//
//// This is a hacked https://github.com/JetBrains/kotlin/blob/master/compiler/cli/src/org/jetbrains/kotlin/cli/jvm/K2JVMCompiler.kt
//
...
//import into.kommon.*
//import kommon.org.jetbrains.kotlin.cli.common.IntoCLICompiler
...
////import org.jetbrains.kotlin.cli.jvm.compiler.IntoKotlinToJVMBytecodeCompiler
...
//
//class IntoK2JVMCompiler : IntoCLICompiler<K2JVMCompilerArguments>() {
//
//    // ---------- @killme { ----------
//
//    companion object {
...
//    }
//
//    override fun setupPlatformSpecificArgumentsAndServices(configuration: CompilerConfiguration, arguments: K2JVMCompilerArguments, services: Services) {
//        throw UnsupportedOperationException("Implement me, please, fuck you")
//    }
//
...
////
////                IntoKotlinToJVMBytecodeCompiler.configureSourceRoots(configuration, moduleScript.modules, directory)
...
////                                  ?: return COMPILATION_ERROR
////
////                IntoKotlinToJVMBytecodeCompiler.compileModules(environment, directory)
////            }
...
////                                  ?: return COMPILATION_ERROR
////
////                return IntoKotlinToJVMBytecodeCompiler.compileAndExecuteScript(environment, paths, scriptArgs)
////            }
////            else {
////                if (destination != null) {
...
////                }
////
////                IntoKotlinToJVMBytecodeCompiler.compileBunchOfSources(environment)
////            }
////
...
////
////        @JvmStatic fun main(args: Array<String>) {
////            IntoCLICompiler.doMain(IntoK2JVMCompiler(), args)
////        }
////
...
//}
//
////fun main(args: Array<String>) = IntoK2JVMCompiler.main(args)
