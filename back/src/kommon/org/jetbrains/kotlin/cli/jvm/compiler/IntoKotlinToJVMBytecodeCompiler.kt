...
// */
//
//// This is a hacked https://github.com/JetBrains/kotlin/blob/master/compiler/cli/src/org/jetbrains/kotlin/cli/jvm/compiler/KotlinToJVMBytecodeCompiler.kt
//
...
//
////object IntoKotlinToJVMBytecodeCompiler {
////
...
////
////        // @into-kotlin
////        AnalyzeKotlinSources.current.environment = environment
////        AnalyzeKotlinSources.current.analysisResult = result
////        return null
////
...
////
////                // @into-kotlin
////                // TODO:vgrechka Unhardcode output directory
////                val outDir = CoreLocalFileSystem().findFileByPath("c:/tmp/into-kotlin")
////                    ?: throw Exception("Cannot find temp output directory")
////                val moduleOutputs = listOf(outDir)
////
