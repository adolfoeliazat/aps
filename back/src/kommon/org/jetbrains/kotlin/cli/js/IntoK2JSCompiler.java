...
// */
//
//// This is a hacked https://github.com/JetBrains/kotlin/blob/master/compiler/cli/src/org/jetbrains/kotlin/cli/js/K2JSCompiler.java
//
//package kommon.org.jetbrains.kotlin.cli.js;
//
...
//import org.jetbrains.kotlin.cli.common.IntoCLICompiler;
...
//
//public class IntoK2JSCompiler extends IntoCLICompiler<K2JSCompilerArguments> {
...
//        doMain(new IntoK2JSCompiler(), args);
//    }
//
//    @NotNull
//    @Override
...
//
//        // @into-kotlin
//        AnalyzeKotlinSources.current.environment = environmentForJS;
//        AnalyzeKotlinSources.current.analysisResult = jsAnalysisResult;
//        if (true) return ExitCode.OK;
//
