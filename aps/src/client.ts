            ...
            if (opts.pageName === 'sign-in') {
                ...
                function enterSignIn() {
                    renameme({
                        ...
                        bottomLinkTitle: t('Still don’t have an account? Create it!', 'Как? Еще нет аккаунта? Срочно создать!'),
                        onBottomLink() {
                            enterSignUp()
                        },
                    })
                    ...
                    setRoot(updatableElement(update => {
                            ...
                            return _=> div(
                                ...
                                formsa({width: '50%', margin: '0 auto'},
                                    ...
                                    hr(),
                                    divsa({textAlign: 'left'}, link(def.bottomLinkTitle, def.onBottomLink)),
                                ))
                        }))
                }
            }
