    ...
    await pgConnection({db: 'test-template-ua-1'}, async function(db) {
        ...
        try {
            ...
            #await simNewSupportThread({stamp: '2014-06-13 11:19:32', upon: 'terkin',
                topic: dedent(`Какая  тут  везде грязь`),
                message: dedent(`Сказал К., покачав головой, и женщине пришлось смахнуть пыль фартуком хотя бы сверху,  прежде чем К. мог взяться за книгу.`)})
            
            #await simNewSupportThread({stamp: '2014-07-16 05:24:17', upon: 'carlos',
            ...
            #await simNewSupportThread({stamp: '2014-08-06 01:33:37', upon: 'regina',
            ...
            #await simNewSupportThread({stamp: '2014-11-25 03:39:53', upon: 'vaganovich',
