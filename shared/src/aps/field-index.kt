...
object fields                                              : Fuckers<FieldSpec>(null) {
    ...
    val userState                                          by namedFucker {TitledEnumSelectFieldSpec(it, t("TOTE", "Статус"), UserState.values())}; val userState_testRef = TestRef(userState)
    ...
    val uaDocumentType                                     by namedFucker {TitledEnumSelectFieldSpec(it, t("TOTE", "Тип документа"), UADocumentType.values())}; val uaDocumentType_testRef = TestRef(uaDocumentType)
