...
//            await(formSubmissionAttempts2(
//                testShit,
//                descr = "Order creation attempts",
//                baseID = "ee5fa2d1-f3be-4f98-a06b-8e327146f65c",
//                attempts = eachOrCombinationOfLasts(listOf(
//                    badTextFieldValuesThenValid2(fieldSpecs.title_testRef, "Особенности перевода правовых документов на основе брачного контракта"),
//                        badTextFieldValuesThenValid2(fieldSpecs.numPages_testRef),
//                        badTextFieldValuesThenValid2(fieldSpecs.numSources_testRef),
//                        badTextFieldValuesThenValid2(fieldSpecs.details_testRef),
//                        badTextFieldValuesThenValid2(fieldSpecs.phone_testRef),
//
//                    todo imposeNextGeneratedPassword2(TestData.bobul.password)
//                ))
//            ))
