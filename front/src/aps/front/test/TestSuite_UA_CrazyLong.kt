...
class Test_UA_CrazyLong_1 : StepBasedTestScenario() {
    ...
    override fun buildSteps() {
        ...
        o.acts {
                    ...
                    for (email in emails) {
                        for (password in passwords) {
                            l += TestAttempt(
                                ...
                                prepare = {async{
                                    await(inputSetValue(fieldSpecs.emailInSignInForm_testRef.name, email.value))
                                    await(inputSetValue(fieldSpecs.passwordInSignInForm_testRef.name, password.value))
                                }}
                            )
                        }
                    }
            ...
            sequence_openPlusForm("a46f92d5-e07d-41cf-bd9d-6559375ca7ad") // http://www.parta.com.ua/referats/view/8470
