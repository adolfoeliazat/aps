...
fun setUpFilesByFedor_2(testShit: TestShit, orderID: String) = async<Unit> {
    ...
    await(send(testShit.fedorToken, WriterAddUAOrderFileRequest()-{o->
        o.orderID.value = orderID
        o.file.testFileOnServer = FileField.TestFileOnServer("crappy release 1.rtf", "${testconst.filesRoot}crappy release 1.rtf")
    ...
    await(send(testShit.fedorToken, WriterAddUAOrderFileRequest()-{o->
        o.orderID.value = orderID
        o.file.testFileOnServer = FileField.TestFileOnServer("crappy release 2.rtf", "${testconst.filesRoot}crappy release 2.rtf")
    ...
    await(send(testShit.fedorToken, WriterAddUAOrderFileRequest()-{o->
        o.orderID.value = orderID
        o.file.testFileOnServer = FileField.TestFileOnServer("crappy release 3.rtf", "${testconst.filesRoot}crappy release 3.rtf")
