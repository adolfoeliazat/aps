...
class Test_UACustomer_DownloadForbiddenFile : StepBasedTestScenario() {
    override fun buildSteps() {
        imf("reimplement Test_UACustomer_DownloadForbiddenFile")
//        o.setUpOrderAndFiles1(testShit)
//        o.acta {
...
class Test_UACustomer_LongFileList : StepBasedTestScenario() {
    ...
    override fun buildSteps() {
        imf("reimplement Test_UACustomer_LongFileList")
...
class Test_UACustomer_Order_Files_Search : StepBasedTestScenario() {
    override fun buildSteps() {
        imf("reimplement Test_UACustomer_Order_Files_Search")
//        o.setUpOrderFilesTestTemplate_1(
//            testShit,
//            setUpUsers = {
...
//
//        o.selectSetValueDescribingStep("filter", CustomerFileFilter.values(), CustomerFileFilter.FROM_WRITER)
//        o.assertScreenHTML("5", "c91c05d1-aedb-44f3-a00a-7875de20642e")
//
//        o.selectSetValueDescribingStep("filter", CustomerFileFilter.values(), CustomerFileFilter.FROM_ME)
//        o.assertScreenHTML("6", "e6164186-36f8-465b-b7ff-81bc7739946a")
//
//        o.selectSetValueDescribingStep("filter", CustomerFileFilter.values(), CustomerFileFilter.ALL)
...
fun TestScenarioBuilder.commonFuckingShit(scenario: StepBasedTestScenario, buildInitFuckingBrowser: (() -> Unit)? = null) {
    imf("reimplement commonFuckingShit")
//    initialShit_killme(scenario)
...
class Test_UACustomer_Order_Files_EditMeta : TestUACustomer_Order_Files_Base() {
    override fun buildSteps0() {
        imf("reimplement Test_UACustomer_Order_Files_EditMeta")
...
class Test_UACustomer_Order_Files_EditFile : StepBasedTestScenario() {
    override fun buildSteps() {
        imf("reimplement Test_UACustomer_Order_Files_EditFile")
//        val ivo1 = MordaBuilder(o)
//        val fedor1 = MordaBuilder(o)
//
...
class Test_UACustomer_Order_Files_Misc : TestUACustomer_Order_Files_Base() {
    override fun buildSteps0() {
        imf("reimplement TestUACustomer_Order_Files_Base")
//        o.acta {TestUserActionAnimation.scroll(700)}
...
fun TestScenarioBuilder.setUpOrderAndFiles1(shit: TestShit) {
    imf("reimplement setUpOrderAndFiles1")
//    val o = this
//    o.setUpOrderFilesTestTemplate_1(
//        shit,
//        setUpUsers = {
...
fun TestScenarioBuilder.setUpOrderFilesTestTemplate_1(
    ...
    if (initFuckingBrowser == null) die("initFuckingBrowser should not be null")
    initFuckingBrowser()
//    (initFuckingBrowser ?: {
