...
fun send(token: String?, req: UACustomerCreateOrderFileRequest): Promisoid<FormResponse2<AddUAOrderFileRequestBase.Response>> = _send(token, req)
fun send(token: String?, req: UAWriterCreateOrderFileRequest): Promisoid<FormResponse2<AddUAOrderFileRequestBase.Response>> = _send(token, req)
