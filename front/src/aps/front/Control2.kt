...
@MixableType
data class Attrs(
    @Deprecated("Kill me") val tame: String? = null,
    @Deprecated("Kill me") val tamy: String? = null,
    @Deprecated("Kill me") val shame: String? = null,
    @Deprecated("Kill me") val shamy: String? = null,
    @Deprecated("Kill me") val tamyShamy: String? = null,
    @Deprecated("Kill me") val controlTypeName: String? = null,
    @Deprecated("Kill me") val tattrs: Json? = null,
    @Deprecated("Kill me") val noStateContributions: Boolean? = null,
    val id: String? = null,
