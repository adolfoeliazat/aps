...
abstract class WriterBootTestScenario : BootTestScenario() {
    ...
    protected fun assert_staticHomePage_rightNavbarSignIn() {
    ...
    protected fun assert_staticHomePage_rightNavbarGaylord() {
        o.assertVisibleText("Приветствуем")
    ...
    protected fun assert_breatheBanner_rightNavbarEmpty() {
