...
object MakeStaticSites {
    ...
    @JsName("runShit")
    fun runShit(argv: dynamic) {"__async"
        try {
    ...
    fun makeWriterSite(lang: Language): Promise<Unit> {"__async"
        ...
        fun writePage(name: String, highlightedItem: String? = null, content: ReactElement) {
            genericWritePage(name=name, highlightedItem=highlightedItem, content=content, root=root, tabTitle=tabTitle, lang=lang, clientKind=ClientKind.WRITER)
        }

        writePage(name = "index", content = Shitus.diva(json(),
            Shitus.diva(json("className" to "container"),
                    ...
                    ua = """
                        ...
                        renderTestimonials(ClientKind.WRITER),
        ...
        writePage(name = "why", highlightedItem = "why", content = Shitus.diva(json(),
            ...
            Shitus.diva(json(),
                ...
                Shitus.diva(json(), markdown(dedent(t(section.content)))))}.toJSArray()
            ))
            ))

        writePage(name = "prices", highlightedItem = "prices", content = Shitus.diva(json(),
            Shitus.diva(json("className" to "container"),
        ...
        writePage(name = "faq", highlightedItem = "faq", content = Shitus.diva(json(),
            Shitus.diva.apply(null, js("[]").concat(json("className" to "container"),
            ...
            Shitus.diva(json(),
                ...
                Shitus.diva(json("style" to json("marginBottom" to 20, "marginTop" to -5)), markdown(dedent(t(section.content)))))}.toJSArray()
            ))
            ))
    ...
    fun writeDynamicPages(names: List<String>, writePage: (String, String, ReactElement) -> Unit) {
        names.forEach {name ->
            writePage(name, "", wholePageTicker())
        }
    }
    ...
    fun makeCustomerSite(lang: Language, currency: Currency): Promise<Unit> {"__async"
        ...
        fun writePage(name: String, highlightedItem: String? = null, content: ReactElement) {
            genericWritePage(name=name, highlightedItem=highlightedItem, content=content, root=root, tabTitle=tabTitle, lang=lang, clientKind=ClientKind.CUSTOMER)
        }
        ...
        writePage(name = "index", content = Shitus.diva(json(),
                Shitus.diva(json("className" to "container"),
                        ...
                        ua = """
                            ...
                            renderTestimonials(ClientKind.CUSTOMER),
        ...
        writePage(name = "samples", highlightedItem = "samples", content = Shitus.diva(json(),
                Shitus.diva(json("className" to "container"),
            ...
            writePage(name = "contact", highlightedItem = "contact", content = Shitus.diva(json(),
                Shitus.diva(json("className" to "container"),
                ...
                """
                    ...
                    Shitus.diva(json("style" to json("marginBottom" to 10)), t(en = "AcademicPaperServed headquarter:", ua = "AcademicPaperServed headquarter:")),
                    Shitus.diva(json("style" to json("whiteSpace" to "pre", "fontFamily" to "monospace")), tdedent(
                        en = """
                            DP World Inc
                            624 W Kristina Ln
                            Round Lake, IL 60073
        ...
        val blogItems = when (lang) {
            ...
            writePage(name = "blog-${item.slug}", highlightedItem = "blog", content = Shitus.diva(json(),
                    Shitus.diva(json("className" to "container"),
        ...
        writePage(name = "blog", highlightedItem = "blog", content = Shitus.diva(json(),
                Shitus.diva(json("className" to "container"),
                    pageHeader(t(en = "Writing Blog", ua = "Писательский Блог")),
                    hrefBullets(blogItems.map{x -> (HrefBulletItem(title = x.listTitle, href = "blog-${x.slug}.html"))})
                    )
            ))
...
//        val name = arg.name; val comp = arg.comp; val highlightedItem = arg.highlightedItem
//        val root = arg.root; val tabTitle = arg.tabTitle; val lang = arg.lang; val clientKind: ClientKind = arg.clientKind
