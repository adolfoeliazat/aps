...
(function(Kotlin) {
  ...
  Kotlin.RuntimeException = createClassNowWithMessage('Kotlin.RuntimeException', Kotlin.Exception);
  Kotlin.NullPointerException = createClassNowWithMessage('Kotlin.NullPointerException', Kotlin.RuntimeException);
  Kotlin.NoSuchElementException = createClassNowWithMessage('Kotlin.NoSuchElementException', Kotlin.RuntimeException);
  Kotlin.IllegalArgumentException = createClassNowWithMessage('Kotlin.IllegalArgumentException', Kotlin.RuntimeException);
  Kotlin.IllegalStateException = createClassNowWithMessage('Kotlin.IllegalStateException', Kotlin.RuntimeException);
  Kotlin.UnsupportedOperationException = createClassNowWithMessage('Kotlin.UnsupportedOperationException', Kotlin.RuntimeException);
  Kotlin.IndexOutOfBoundsException = createClassNowWithMessage('Kotlin.IndexOutOfBoundsException', Kotlin.RuntimeException);
  Kotlin.ClassCastException = createClassNowWithMessage('Kotlin.ClassCastException', Kotlin.RuntimeException);
  Kotlin.IOException = createClassNowWithMessage('Kotlin.IOException', Kotlin.Exception);
  Kotlin.AssertionError = createClassNowWithMessage('Kotlin.AssertionError', Kotlin.Error);
...
module.exports = function(Kotlin) {
  var _ = Kotlin.defineRootPackage(null, {kotlin:Kotlin.definePackage(null, {collections:Kotlin.definePackage(function() {
    ...
    this.section = "В§";
    this.copyright = "В©";
    this.leftGuillemete = "В«";
    this.rightGuillemete = "В»";
    this.registered = "В®";
    this.degree = "В°";
    this.plusMinus = "В±";
    this.paragraph = "В¶";
    ...
    this.ndash = "вЂ“";
    this.mdash = "вЂ”";
    this.leftSingleQuote = "вЂ�";
    this.rightSingleQuote = "вЂ™";
    this.lowSingleQuote = "вЂљ";
    this.leftDoubleQuote = "вЂњ";
    this.rightDoubleQuote = "вЂќ";
    this.lowDoubleQuote = "вЂћ";
    this.dagger = "вЂ ";
    this.doubleDagger = "вЂЎ";
    this.bullet = "вЂў";
    this.ellipsis = "вЂ¦";
    this.prime = "вЂІ";
    this.doublePrime = "вЂі";
    this.euro = "в‚¬";
    this.tm = "в„ў";
    this.almostEqual = "в‰€";
    this.notEqual = "в‰ ";
    this.lessOrEqual = "в‰¤";
    this.greaterOrEqual = "в‰Ґ";
